class DaisySheetModal extends HTMLElement {
    ...
    get handleShadow() {
        ...
        return this.getAttribute("handle-shadow") || "shadow";
    }
    ...
    _renderStructure() {
        ...
        modal.id = `${id}modal`;
        modal.className = 'daisy-sheet-modal fixed left-1/2 right-auto bottom-0 z-50 rounded-t-3xl shadow-2xl mx-auto flex flex-col';
